      ...
      child: Column(
        children: <Widget>[
          ...
          SizedBox(
            ...
            child: const Text(
              'MBBS (International Medical University, Malaysia), MRCP (Royal Collecge of Physicians, United Kingdom )',
              style: TextStyle(
                color: Colors.grey,
                fontSize: 15,
              ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Config.spaceSmall,
          Text(
            'Dr. ${doctor['doctor_name']} is an experienced ${doctor['category']} Specialist at Jakarta. Graduated since 2008, and completed his/her training at Singapore General Hospital.',
            style: const TextStyle(
